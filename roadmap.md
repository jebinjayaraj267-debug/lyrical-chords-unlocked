...
- [x] ChordMini proxy route `/api/chordmini` (multipart `file` + `model` → `/api/detect-beats` + `/api/recognize-chords`)
- [x] ChordMini adapter + on-device fallback in analyze flow
